...
public class nhaphangGUI  extends JPanel{
    ...
    private void init() throws Exception {
        ...
        tblsp.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        ...
        tblsp2.setDefaultEditor(Object.class, null);
        tblsp2.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
